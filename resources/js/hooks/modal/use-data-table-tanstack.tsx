...
interface UseDataTableProps {
  ...
  parametrosColumna?: Record<string, unknown>; // parámetros personalizados para columnas
  parametrosDatos?: Record<string, unknown>;    // parámetros personalizados para datos
}
...
export function useDataTable({
  ...
  useEffect(() => {
    ...
    fetchColumns();
  }, [open, columnsRoute, parametrosColumna]);
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [open, dataRoute, parametrosDatos]);
