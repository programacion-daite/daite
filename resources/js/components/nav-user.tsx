                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <SidebarMenuButton
                            size="lg"
                            className={cn(
                                "text-sidebar-accent-foreground data-[state=open]:bg-sidebar-accent group",
                                "lg:flex-row lg:justify-start lg:gap-2 lg:px-4 lg:py-2", // For large screens, adjust layout
