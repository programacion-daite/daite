...
export function lazyLoad<T extends ComponentType<any>>(importFunc: () => Promise<{ default: T }>, LoadingComponent = DefaultLoading) {
...
export function lazyLoadRoute<T extends ComponentType<unknown>>(importFunc: () => Promise<{ default: T }>) {
